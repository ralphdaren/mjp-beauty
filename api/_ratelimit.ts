...
export const trainingReadLimiter = makeLimiter('training-read', 60, '1 m')
export const trainingCreateLimiter = makeLimiter('training-create', 5, '10 m')
export const locationLimiter = makeLimiter('location', 30, '1 m')
export const servicesLimiter = makeLimiter('services', 60, '1 m')
export const manageBookingLimiter = makeLimiter('manage-booking', 10, '10 m')
